...
c_fileIDZIP			= pE.File( c_strID + ".processed.1.zip" )
c_fileIDSDRF		= pE.File( c_strID + ".sdrf.txt" )
...
arepa.sconscript_children( pE, afileIDsTXT, funcScanner, 2, locals( ) )
